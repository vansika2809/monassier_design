...
import 'package:monassier_design/constants/firestore_constants.dart';
import 'package:monassier_design/models/message_chat.dart';
            ...
            messageChat.type == TypeMessage.text
                ...
                ? Row(
                    children: [
                      ...
                      // CircleAvatar(child: Icon(Icons.person_sharp,color: ColorConstants.greyColor,),backgroundColor: Colors.grey.shade300,)
                    ],
                  )
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          this.peerNickname,
          style: GoogleFonts.kalam(color: ColorConstants.greyColor),
        ),
        centerTitle: true,
        actions: [
